...
\vspace{0.2em}  
  ...
  \item Contributed to real-time communication software between Scan Controller, ARM processor, and host PC, 
      working with UDP/TCP protocols and PTP synchronization, including troubleshooting to improve data transmission stability.
...
\vspace{0.4em}
\begin{itemize}[leftmargin=*]
  \item Diagnosed and resolved WAN network faults (proactive and reactive), working extensively with IPv4/IPv6, 
      MPLS, and routing protocols including OSPF, RIP, EIGRP, and BGP, ensuring SLA compliance and service continuity.
